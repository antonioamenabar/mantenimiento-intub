...
estado): armar el borrador de una Orden de Trabajo -- Inspección, Fallas
y/o Mantenimiento Programado, de uno o varios camiones -- y despacharla a
uno o más mecánicos/talleres.
"""
import sys
...
st.markdown("<h1 style='text-align:center;'>➕ Crear OT</h1>", unsafe_allow_html=True)
mostrar_flash()
...
if asignables.empty:
    st.warning(
        ...
        "Ve a **Administración** y agrega al menos uno antes de crear una OT."
    )
else:
